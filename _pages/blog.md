...
<ul class="post-list">
  ...
  {% for post in postlist %}
    ...
    <li>
      {% if post.thumbnail %}<div class="post-list-with-thumbnail">{% endif %}
      <h3>
      ...
      {% if post.thumbnail %}
        <img class="card-img" src="{{ post.thumbnail | relative_url }}" alt="" loading="lazy">
      {% endif %}
      {% if post.thumbnail %}</div>{% endif %}
    </li>
  {% endfor %}
</ul>
